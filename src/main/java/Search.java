    ...
    public static void searchingClient() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Erro ao pesquisar o cliente: " + exception.getMessage());
    ...
    public static void searchingProduct() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Erro ao pesquisar o produto: " + exception.getMessage());
                exception.printStackTrace();
            }
        } catch (SQLException exception) {
            System.err.println("Erro ao se conectar ao banco: " + exception.getMessage());
    ...
    public static void searchingSale() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Erro ao pesquisar a venda: " + exception.getMessage());
                exception.printStackTrace();
            }
        } catch (SQLException exception) {
            System.err.println("Erro ao se conectar ao banco: " + exception.getMessage());
    ...
    public static void searchingSupplier() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Erro ao pesquisar o fornecedor: " + exception.getMessage());
                exception.printStackTrace();
            }
        } catch (SQLException exception) {
            System.err.println("Erro ao se conectar ao banco: " + exception.getMessage());
    ...
    public static void searchingSeller() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Erro ao selecionar o vendedor: " + exception.getMessage());
                exception.printStackTrace();
            }
        } catch (SQLException exception) {
            System.err.println("Erro ao se conectar ao banco: " + exception.getMessage());
